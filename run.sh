...
python fl_train_clsPasData_async.py --client_num  4 --c_rounds 2000 --round_per_train 100 --version brats20_rf_c4_3m_dup50 --resume 0
python fl_train_clsPasData_async.py --client_num  4 --c_rounds 2000 --round_per_train 100 --version brats20_rf_c4_3m_dup50 --resume 1
