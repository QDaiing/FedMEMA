...
from utils.predict import AverageMeter, global_test, local_test, softmax_output_dice_class4, softmax_output_dice_class5
...
if __name__ == '__main__':
    ...
    train_set = GLB_Brats_train(transforms=args.train_transforms, root=args.datapath,
    ...
    for epoch in range(args.num_epochs):
        ...
        if (epoch+1) % 50 ==0 : #and (epoch+1) > 400:
            with torch.no_grad():
                ...
                dice_score = global_test(valid_loader, model, args.device, args.dataname, mask)
