...
def run_kmeans(x, nmb_clusters, verbose=False):
    ...
    # clus.niter = 20     # 迭代次数clustering iterations
    # clus.max_points_per_centroid = 10000000 # to limit size of dataset
    ...
    # return centroids, [int(n[0]) for n in labels], losses[-1]
